...
// Commands:
//   SETALL:<j0>,<j1>     - Set both joint positions
...
//
// Responses:
//   FEEDBACK:<j0_p>,<j0_v>;<j1_p>,<j1_v>  - All joint feedback (100ms interval)
...
const uint8_t ODRIVE_NODE_IDS[NUM_JOINTS] = {1, 2};
...
ODriveCAN* odrives[NUM_JOINTS] = {&odrv0, &odrv1};
...
void setup() {
  ...
  Serial.println("Two-Motor Test - ODrive Multi-Motor Control");
